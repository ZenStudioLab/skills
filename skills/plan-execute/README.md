# Plan Execute — Peer LLM Workflow

Part of the [Peer LLMs](../README.md) skill for inter-LLM collaboration workflows.

## Overview

Executes a finalized plan by delegating coding to a coding agent (default: Codex). Claude orchestrates, agent codes, Claude reviews — iterating until quality passes. Use `opencode` prefix to override provider.
...
- [Codex CLI](../codex/README.md) — Default coding agent for plan execution
- [OpenCode CLI](../opencode/README.md) — Alternative coding agent (use `opencode` prefix)
- [Plan Review](../plan-review/README.md) — Reviews plans before execution
